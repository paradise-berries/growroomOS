(function ($) {
  Drupal.behaviors.growroom_theme_vbo = {
    attach: function (context, settings) {
      ...
      // Reset the buttons.
      Drupal.behaviors.growroom_theme_vbo.reset_buttons(context);
      ...
      if ((typeof Drupal.settings.growroom_theme !== 'undefined') && (typeof Drupal.settings.growroom_theme.vbo_hide !== 'undefined')) {
        ...
        var view_name = Drupal.settings.growroom_theme.view_name;
        var view_display = Drupal.settings.growroom_theme.view_display;
